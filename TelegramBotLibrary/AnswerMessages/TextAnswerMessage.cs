...
namespace TelegramBotLibrary.AnswerMessages
{
    ...
    public class TextAnswerMessage : IAnswerMessage
    {
        ...
        /// <summary>
        /// Инициализация ответа с кнопками.
        /// </summary>
        /// <param name="text"></param>
        /// <param name="replyMarkup"></param>
        public TextAnswerMessage(string text, IReplyMarkup replyMarkup) 
	        : this(text)
        {
	        ReplyMarkup = replyMarkup;
		}

		public TextAnswerMessage(string text, ParseMode parseMode, bool isDisableNotification, int? replyToMessageId, IReplyMarkup replyMarkup, CancellationToken cancellationToken) 
			: this(text)
        {
            ParseMode = parseMode;
