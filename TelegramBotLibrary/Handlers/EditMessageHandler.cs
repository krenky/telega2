...
{
    public class EditMessageHandler : IEditMessageHandler
	{
        public virtual async Task HandleEditAsync(ITelegramBotClient botClient, Message message, IAnswer answer, CancellationToken cancellationToken)
        {
            try
            {
                    ...
                    case Telegram.Bot.Types.Enums.MessageType.Text:
                        {
                            ...
                            await botClient.EditMessageTextAsync(
                                ...
                                replyMarkup: (Telegram.Bot.Types.ReplyMarkups.InlineKeyboardMarkup?)textAnswer.ReplyMarkup,
